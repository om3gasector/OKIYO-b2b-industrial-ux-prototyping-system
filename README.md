...
Провел юзабилити-тест с реальным пользователем (без знания английского и без опыта в промышленности).
**Результат:** пользователь интуитивно нашел прибор, изучил характеристики и оставил заявку за 25 секунд. Это доказало, что визуальная структура работает даже без локализации и отраслевых знаний.
